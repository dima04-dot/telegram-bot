...
PLANET_KEYWORDS = {
    ...
    "Сатурн": ["структура", "структурный", "работа", "работе", "работать", "труд", "планировать",
               "план", "планирование", "администрация", "административный", "управлять",
